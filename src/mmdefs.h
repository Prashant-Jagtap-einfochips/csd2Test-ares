...
$Header: //components/rel/audio.qxa_qa/2.0.c13/audio_ar/audio_driver/public/amss/multimedia/audio_driver_ar/mmdefs.h#1 $
...
#define bool_t bool_tt         /* avoid conflict definition of bool_t from platform */
